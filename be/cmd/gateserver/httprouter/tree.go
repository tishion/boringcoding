...
func (n *node) addRoute(path string, handle RouteHandler) {
	fullPath := path
	n.priority++
...
func (n *node) insertChild(numParams uint8, path, fullPath string, handle RouteHandler) {
...
// given path.
func (n *node) getValue(path string) (handle RouteHandler, p Params, tsr bool) {
